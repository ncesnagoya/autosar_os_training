	...
	for(;;){
		...
		if(dsw_state != pre_dsw_state){
			if(((dsw_state & DSW1) == DSW1) && ((pre_dsw_state & DSW1) != DSW1)){
				syslog(LOG_INFO, "DisableAllInterrupts()");
				DisableAllInterrupts();
			}

			if(((dsw_state & DSW1) != DSW1) && ((pre_dsw_state & DSW1) == DSW1)){
				syslog(LOG_INFO, "EnableAllInterrupts()");
				EnableAllInterrupts();
			}

			if(((dsw_state & DSW2) == DSW2) && ((pre_dsw_state & DSW2) != DSW2)){
				syslog(LOG_INFO, "SuspendOSInterrupts()");
				SuspendOSInterrupts();
			}

			if(((dsw_state & DSW2) != DSW2) && ((pre_dsw_state & DSW2) == DSW2)){
				syslog(LOG_INFO, "ResumeOSInterrupts()");
				ResumeOSInterrupts();
			}

			if(((dsw_state & DSW3) == DSW3) && ((pre_dsw_state & DSW3) != DSW3)){
				syslog(LOG_INFO, "SuspendAllInterrupts()");
				SuspendAllInterrupts();
			}

			if(((dsw_state & DSW4) == DSW4) && ((pre_dsw_state & DSW4) != DSW4)){
				syslog(LOG_INFO, "ResumeAllInterrupts()");
				ResumeAllInterrupts();
			}
