...
TASK(main_task){
	...
	for(;;) {
		...
		if(((dsw_state & DSW1) == DSW1) && ((pre_dsw_state & DSW1) != DSW1)){
			syslog(LOG_INFO, "main_task : SetRelAlarm(alarm_callback, TICK_FOR_10MS*100, 0).");
			SetRelAlarm(alarm_callback, TICK_FOR_10MS*100, 0);
		}
		...
		if(((dsw_state & DSW2) == DSW2) && ((pre_dsw_state & DSW2) != DSW2)){
			syslog(LOG_INFO, "main_task : SetRelAlarm(alarm_callback, TICK_FOR_10MS*100, TICK_FOR_10MS*100).");
			SetRelAlarm(alarm_callback, TICK_FOR_10MS*100, TICK_FOR_10MS*100);
		}
		...
		if(((dsw_state & DSW4) == DSW4) && ((pre_dsw_state & DSW4) != DSW4)){
			syslog(LOG_INFO, "main_task : SetRelAlarm(alarm_act_task, TICK_FOR_10MS*20, TICK_FOR_10MS*20).");
			SetRelAlarm(alarm_act_task, TICK_FOR_10MS*20, TICK_FOR_10MS*20);
		}
